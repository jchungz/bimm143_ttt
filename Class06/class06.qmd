...
author: "Jaimy Chung (PID:A16366976)"
date : 01/25/2024
format: pdf
editor: visual
---
...
This is not fair - there is no way student 3 should have a mean of 90!
...
#Remove highest score and find the mean
mean(student1[-ind])
```
...
x <- student3
  ...
  x[is.na(x)] <- 0
  #Find and remove min values to get mean
  mean(x[-which.min(x)])
```
...
```
Hw5 was most predictive as it has the highest correlation w the avg grade score.
