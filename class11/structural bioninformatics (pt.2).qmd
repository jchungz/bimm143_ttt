...
If the predicted model has more than one domain, each domain may have confidence, yet the relative positions of the fomains may not. The estimated reliability of relative domain positions is in graphs of predicted aligned error (PAE) which are included in the downloadable zip file and analyzed in R above. 
